...
with open(fname) as csv_file:
    ...
    for row in csv_reader:
        ...
        lineItem_UsageStartDate = row[9].split("T", 1)[0]    # The start date and time for the line item in UTC, inclusive. The format is YYYY-MM-DDTHH:mm:ssZ.
        lineItem_UsageEndDate = row[10].split("T", 1)[0]     # The end date and time for the corresponding line item in UTC, exclusive. The format is YYYY-MM-DDTHH:mm:ssZ.
